...
extern int register_com_modou_loc_data_transfer_DataTransferMgr2(JNIEnv *env);
...
jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    if(register_com_modou_loc_data_transfer_DataTransferMgr2(env) != JNI_OK) {
    	__android_log_print(ANDROID_LOG_ERROR, TAG, "can't load register_com_modou_loc_data_transfer_DataTransferMgr");
        goto end;
	}
