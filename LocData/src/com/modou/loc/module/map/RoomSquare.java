...
import com.modou.fragment.CategoryFragment;
...
//	//Object to draw room number texture
	...
	public RoomSquare(float doorX, float doorY, String hallSide, String doorLocation, float width, 
			float height, String colorString, Activity iD, int i) {
	 ...
	 */
	public void loadGLTexture(GL10 gl, Activity miD) {
	...
	public void DrawTexture(GL10 gL) {
		if(CategoryFragment.ShowRoomNums() && TexSq.getTextureNum() != -1)
			TexSq.Draw(gL);
	}
}
